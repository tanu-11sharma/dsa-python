...
- Stats: **90 / 450 solved** · Day 17 / 90 · Next topic index: 3

> Note (2026-08-17): is_graph_bipartite.py was also committed to the repo during the Day 17 window by a source outside this automation. It is present in the repo but is NOT counted in the total above.
...
| 17 | 2026-08-17 | Backtracking, Graphs (BFS/DFS, topological sort), Arrays & Hashing, Two Pointers, Sliding Window | generate_balanced_parentheses.py, alien_dictionary_topological_order.py, encode_decode_strings_list.py, two_sum_sorted_two_pointers.py, minimum_size_subarray_sum.py | 90 |
